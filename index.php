        ...
        <div class="row">
            <div class="col-lg-7 col-xl-5">
                <div class="text-container">
                    <h1 class="h1-large">Welcome to H.e Future</h1>
                    <p class="p-large">Welcome to H.e Future Development, Grow your future</p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-xl-7">
                <div class="text-container">
                    <h2>About H.E Future</h2>
                    <p class="p-large">H.E future development is a digital solution provider company, which works in the health and education sector.
                        H.E future development provides a digital solution to the members of organization in the health and education sector. in this time there are many types of problems in society in the health and education sector. Through our organization, we try to help people to overcome those problems by bringing all the services of these sectors on one platform.

                        H.E future development works on helping and earning criteria, by bringing all those services on one platform we are helping people in saving his time by getting a quality product on demand at a reasonable price after getting the membership of our organization and if those members are bringing other people to our organization as a member then they will also get good earning from the organization.</p>
